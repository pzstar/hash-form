...
class HashSmtp {
    ...
    public function smtp() {
        ...
        <div class="hf-smtp-page">
            <div class="hf-require-wp-mail-smtp-notice">
                ...
                <p><?php printf(esc_html__("See Detail Article %1shere%2s", "hash-form"), '<a href="https://www.hostinger.com/tutorials/wordpress-smtp" target="_blank">', '</a>'); ?></p>
                <?php
    ...
    public static function redirect_to_smtp_settings() {
        if (HashHelper::is_admin_page('hashform-smtp') && function_exists('wp_mail_smtp') && (is_plugin_active('wp-mail-smtp/wp_mail_smtp.php'))) {
