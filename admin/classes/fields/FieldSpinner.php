...
class FieldSpinner extends FieldType {
    ...
    protected function input_html() {
        ...
        $html = '<div class="hf-quantity">';
        $html .= '<div class="hf-quantity-input">';
        $html .= '<span class="mdi-minus"></span>';
        $html .= '<input inputmode="numeric" autocomplete="off" type="number" ' . $this->field_attrs() . '>';
        $html .= '<span class="mdi-plus"></span>';
        $html .= '</div>';
        $html .= '</div>';
