...
?>
<p>
    <?php esc_html_e('Changing the captcha type here will replace it in all any forms where it is used.', 'hash-form'); ?>
</p>
<p>
    <?php printf(esc_html__('%1$s requires a Site and Private API key. Sign up for a %2$sfree %1$s key%3$s.', 'hash-form'), esc_html('reCAPTCHA'), '<a href="' . esc_url('https://www.google.com/recaptcha/') . '" target="_blank">', '</a>'); ?>
</p>
