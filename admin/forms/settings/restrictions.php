...
<div class="hf-form-container hf-grid-container">
    ...
    <div class="hf-form-row hf-grid-container">
        <div class="hf-grid-3">
            ...
            <p class="hf-setting-description"><?php esc_html_e('Logged in visitors are matched by their account, guests by IP address.', 'hash-form'); ?></p>
        </div>
    </div>

    <div class="hf-form-row hf-grid-container" data-condition-toggle="hf-one-entry" data-condition-val="on">
        <div class="hf-grid-3">
    ...
    if (!defined('HASH_FORM_PRO_VERSION')) {
        ...
        <div class="hf-form-row hf-grid-container">
            <div class="hf-grid-3">
                <p class="hf-setting-description">
