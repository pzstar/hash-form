...
const Tabs = ({children}) => {
    ...
    return <>
        <div className="hf-field hf-inspect-tabs ">
            <div className="components-tab-panel__tabs">
                {children.map(function (n) {
                    return <>
                        {(!1 !== n &&
                            <Tooltip text={n.props.tabTitle}>
                                <button className={(n.props.tabTitle === activeTab ? "active-tab" : "") + " components-button hf-tab-menu"}
            ...
            <div className="hf-field-tab-items">
